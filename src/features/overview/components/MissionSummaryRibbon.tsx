...
interface MissionSummaryRibbonProps {
  metrics: MetricItem[];
}

export const MissionSummaryRibbon: React.FC<MissionSummaryRibbonProps> = React.memo(({ metrics }) => (
...
MissionSummaryRibbon.displayName = 'MissionSummaryRibbon';
